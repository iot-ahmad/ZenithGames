...
targetY=u>0?y-45:190
if(targetY>n+6)q=4
else if(targetY<n-6)q=-4
else q=0
...
document.onkeydown=function(e){k=(e||window.event).keyCode;w=w?0:k=='27'?1:0;p=k=='40'?5:k=='38'?-5:p;}
document.onkeyup=function(e){k=(e||window.event).keyCode;p=k=='38'||k=='40'?0:p;}
